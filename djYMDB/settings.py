"""
Django settings for djYMDB project.
...
WSGI_APPLICATION = 'djYMDB.wsgi.application'
...
# This will tel wher exactly static files lies
# othewrise add a static/my_app/ directory to my_app
#STATICFILES_DIRS = (
